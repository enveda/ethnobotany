...
def draw_clade(
    ...
    #     if clade.name in ['Trigonella_foenum-graecum', 'Artemisia_absinthium']:
    #         ldepth = depth
    #     elif clade.name in [
    #         'Allium_sativum', 'Zingiber_officinale', 'Berberis_vulgaris', 'Andropogonodae',
    #         'Cinnamomum_verum', 'Hibiscus_sabdariffa', 'Cyperus_incertae_sedis', 'Acorus_calamus'
    #     ]:
    #         ldepth = depth + 30
    #     elif clade.branch_length <= 19.0 or clade.name in [
    #         'Carica_papaya', 'Artemisia_absinthium', 'Oroxylum_indicum', 'Phyllanthus_emblica',
    #         'Hibiscus_sabdariffa', 'Artocarpus_heterophyllus',
    #     ]:
    #         ldepth = depth + pad_label + 100
    #     else:
...
def polar_plot(
    ...
    root_distance=.1, patch_leaf=True, wedge=True, pad_label=0,
    ...
    pad_label = pad_label or total_size * .08
